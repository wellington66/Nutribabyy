...
const HERO_IMG = "/hero-nutribaby.webp";
const MAE_PREPARANDO_IMG = "/mae-preparando.webp";
const LOGO_IMG = "/nutribaby-logo-full.webp";
const KIT_COMPLETO_IMG = "/kit-completo-mockup.webp";
...
const GUIA_ESSENCIAL_IMG = guiaEssencialImg;
...
function UrgencyBar() {
  ...
  return (
    <div className="relative z-50 overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-700 text-white shadow-[0_2px_12px_rgba(220,38,38,0.4)]">
      ...
      <div className="container-page relative flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5 px-3 py-1 text-center text-[10px] font-extrabold uppercase tracking-wide sm:py-1.5 sm:text-[12px]">
        ...
        <span className="text-yellow-300">🔥 Somente agora com 70% OFF</span>
        <span className="opacity-70">•</span>
        <span className="hidden sm:inline">Expira em</span>
        <span className="sm:hidden">Expira</span>
        <span className="ml-0.5 inline-flex items-center gap-1 rounded bg-black/30 px-1.5 py-0.5 font-mono text-[11px] tabular-nums tracking-widest text-yellow-300 shadow-inner sm:text-[13px]">
  ...
  return (
    <section id="introduction-truth" className="overflow-hidden bg-[#F8F0E7] px-4 py-10 sm:px-6 sm:py-16">
      <div className="mx-auto w-full max-w-5xl text-center">
        <img
          src="/verdade-introducao-alimentar.jpeg"
...
function Offers() {
  ...
  const onKitClick = () => {
    ...
    track("InitiateCheckout", { plan: "kit", value: 27.0 });
  };
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2 lg:items-stretch">
          ...
          <article className="relative order-2 flex flex-col overflow-hidden rounded-3xl border-4 border-primary bg-card p-6 shadow-[0_25px_60px_-15px_hsl(var(--primary)/0.55)] ring-4 ring-primary/20 sm:p-8 lg:scale-[1.03]">
            ...
            <div className="mt-5 rounded-2xl bg-gradient-to-br from-primary/10 to-transparent p-4">
              ...
              <div className="mt-1 flex items-baseline gap-1">
                ...
                <span className="font-serif text-6xl font-bold leading-none tabular-nums text-primary">27,00</span>
              </div>
              <p className="mt-1 text-xs font-semibold text-foreground">
                à vista • ou 3x de R$ 9,60
              </p>
              <p className="mt-1 text-xs italic text-primary">
                Apenas R$ 12,10 a mais que o Guia Essencial.
              </p>
            </div>
            ...
            >
              Quero o Kit Completo por R$ 27,00
          ...
          <article className="order-1 flex flex-col rounded-3xl border border-border bg-card p-6 sm:p-8">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="font-serif text-5xl leading-none tabular-nums">14,90</span>
            </div>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <h3 className="mt-3 pr-8 font-serif text-xl leading-tight sm:mt-4 sm:pr-0 sm:text-3xl">
            Quer levar o Kit Completo por apenas R$ 7,00 a mais?
          </h3>
          ...
          <div className="mt-4 rounded-2xl border border-primary/40 bg-primary/5 p-4 sm:mt-5 sm:p-5">
            <div className="flex items-baseline justify-between text-sm">
              ...
              <span className="font-semibold tabular-nums">R$ 14,90</span>
            </div>
            ...
            <p className="mt-3 text-xs italic text-foreground/80">
              Por apenas R$ 7,00 a mais, você leva a opção completa.
            </p>
          </div>
          ...
          <a
            ...
            onClick={() => {
              ...
              track("InitiateCheckout", { plan: "kit_promo", value: 21.9 });
            }}
          ...
          >
            Sim, quero o Kit Completo por R$ 21,90
            <ArrowRight className="h-4 w-4" />
          </a>
          <a
            href={ESSENCIAL_URL}
            onClick={() => {
              ...
              track("InitiateCheckout", { plan: "essencial", value: 14.9 });
            }}
          ...
          >
            Quero continuar com o Guia de R$ 14,90
          </a>
      ...
      {confirmClose && (
        <div className="fixed bottom-24 left-1/2 z-[65] -translate-x-1/2 rounded-full border border-border bg-card px-5 py-3 text-xs shadow-xl">
          Continuando com o Guia por R$ 14,90 —{" "}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Tenha receitas, cardápios, lista de compras e 14 videoaulas sobre cortes por R$ 21,90.
        </p>
        <a
          href={KIT_PROMO_URL}
          onClick={() => {
        ...
        >
          Quero o Kit Completo por R$ 21,90
          <ArrowRight className="h-4 w-4" />
        </a>
        <button
          onClick={() => setOpen(false)}
      ...
      {!seenOffers ? (
        <div className="flex items-center gap-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="font-serif text-xl leading-none tabular-nums">R$ 14,90</p>
          </div>
          <button
            onClick={() => {
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-3">
            <div className="min-w-0 flex-1">
              ...
              <p className="font-serif text-xl leading-none tabular-nums">R$ 27,00</p>
            </div>
            <a
              href={KIT_URL}
              onClick={() => {
  ...
  return (
    <section className="overflow-hidden bg-[#F8F0E7] px-4 py-10 sm:px-6 sm:py-14">
      <div className="mx-auto w-full max-w-4xl">
        <img
          src="/15%20dias%20de%20garantia.jpeg"
...
function SalesPopup() {
  ...
  const notifications = [
    { name: "Amanda R.", city: "São Paulo, SP", product: "Kit Completo", price: "R$ 27,00", ago: "há 2 min" },
    { name: "Juliana M.", city: "Rio de Janeiro, RJ", product: "Guia Essencial", price: "R$ 14,90", ago: "há 4 min" },
    { name: "Carolina S.", city: "Belo Horizonte, MG", product: "Kit Completo", price: "R$ 27,00", ago: "há 6 min" },
    { name: "Fernanda L.", city: "Curitiba, PR", product: "Kit Completo", price: "R$ 27,00", ago: "há 8 min" },
    { name: "Patrícia B.", city: "Porto Alegre, RS", product: "Guia Essencial", price: "R$ 14,90", ago: "há 11 min" },
    { name: "Bianca T.", city: "Salvador, BA", product: "Kit Completo", price: "R$ 27,00", ago: "há 13 min" },
    { name: "Larissa O.", city: "Recife, PE", product: "Kit Completo", price: "R$ 27,00", ago: "há 15 min" },
    { name: "Camila F.", city: "Fortaleza, CE", product: "Kit Completo", price: "R$ 27,00", ago: "há 18 min" },
    { name: "Mariana P.", city: "Brasília, DF", product: "Kit Completo", price: "R$ 27,00", ago: "há 21 min" },
    { name: "Renata A.", city: "Florianópolis, SC", product: "Kit Completo", price: "R$ 27,00", ago: "há 24 min" },
    { name: "Débora N.", city: "Goiânia, GO", product: "Kit Completo", price: "R$ 27,00", ago: "há 27 min" },
    { name: "Vanessa C.", city: "Manaus, AM", product: "Guia Essencial", price: "R$ 14,90", ago: "há 30 min" },
  ];
